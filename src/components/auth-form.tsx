    ...
    try {
      ...
      if (isSignup) {
        const { error: authError } = await supabase.auth.signUp({
          email,
          password,
          options: { data: { full_name: String(data.get("fullName")), phone: String(data.get("phone")), room: String(data.get("room")) } },
        });
      ...
      <section className="auth-panel">
        <div className="auth-box">
          ...
          <form onSubmit={submit}>
            ...
            {!isSignup && <div className="form-options"><label className="checkbox"><input type="checkbox" /> <span>Keep me signed in</span></label><a href="#">Forgot password?</a></div>}
