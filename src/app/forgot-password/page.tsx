...
export default function ForgotPasswordPage() {
  return <main className="auth-page">
    <section className="auth-brand"><Logo /><div className="auth-brand-copy"><span className="eyebrow light">CV 105 community mess</span><h1>Recover your account safely.</h1><p>Password recovery is handled by an authorised mess officer after identity verification.</p></div></section>
